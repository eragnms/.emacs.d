...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (undo-tree volatile-highlights graphql magit magit-p4 org-bullets smartparens smartparens-config srefactor company-c-headers wgrep use-package sr-speedbar py-autopep8 org iedit helm-projectile helm-gtags function-args flycheck elpy better-defaults)))
